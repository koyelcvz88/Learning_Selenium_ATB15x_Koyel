...
public class MakeMyTrip_Ex extends CommonToAll {
    @Test
    public void test_makemytrip_flights() {
        ...
        try {
            List<WebElement> list_auto_complete_dropdown = driver.findElements(By.xpath
        ...
        try {
            List<WebElement> list_auto_complete =
                    driver.findElements(By.xpath("//ul[@class=\"react-autosuggest__suggestions-list\"]/li"));
